...
function ManageProduct({P, DP, addCart}) {
            ...
            sortedProducts.map(e=>(
                <div key={e.id} className="product-card">
                    ...
                    {/* {
                        C.some(c => c.id === e.id) ? (
                            <div>
                                <button onClick={() => addCart(e)} className='btn btn-primary' disabled>Already In Cart</button><br />
                                <Link to='/Cart' className='btn btn-info'>Go To Cart</Link>
                            </div>
                        ) : (
                            <div>
                                <button onClick={() => addCart(e)} className='btn btn-primary'>Add To Cart</button>
                            </div>
                        )
                    } */}
